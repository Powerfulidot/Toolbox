'''
Description   : 通过三种哈希、两种直方图及SSIM算法比较图片相似度
Time          : 2024/10/30 11:32:22
Author        : 宽后藤 
'''
...
def classify_hist_with_split(image1, image2, size=(256, 256)):
    ...
    # sub_data = cv2.compareHist(hist_img1, hist_img2, cv2.HISTCMP_CORREL)
...
def SSIM(img1, img2):
    ...
    ssim_score = structural_similarity(img1, img2, full=True)
...
def runAllImageSimilaryFun(para1, para2):
    ...
    print('均值哈希算法相似度aHash：', n1, (1 - float(n1 / 64)))
 
    hash1 = dHash(img1)
    hash2 = dHash(img2)
    n2 = cmpHash(hash1, hash2)
    print('差值哈希算法相似度dHash：', n2, (1 - float(n2 / 64)))
 
    hash1 = pHash(img1)
    hash2 = pHash(img2)
    n3 = cmpHash(hash1, hash2)
    print('感知哈希算法相似度pHash：', n3, (1 - float(n3 / 64)))
...
if __name__ == "__main__":
    p1 = 'C:/Users/29560/Desktop/1.jpg'
    p2 = 'C:/Users/29560/Desktop/2.jpg'
